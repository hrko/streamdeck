...
func connectElgatoStreamDeckSocket[SettingsT Settings](ctx context.Context, inPort int, inPropertyInspectorUUID string, inRegisterEvent string, inInfo streamdeck.Info, inActionInfo streamdeck.ActionInfo[SettingsT], s SettingsT) (*SDClient[SettingsT], error) {
	fmt.Printf("inPort:%#v\n", inPort)
